(function () {
    ...
    const applyTheme = (theme) => {
        ...
        document.querySelectorAll(".themes button").forEach((button) => button.classList.remove("active"));
        const activeButton = document.querySelector(`.themes button[data-theme="${theme}"]`);
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        Object.keys(themes).forEach((theme) => {
            ...
            button.innerHTML = `<div style="font-size: 20px;">Aa</div><div>${theme}</div>`;
